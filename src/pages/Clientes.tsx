      ...
      <div className="bg-background rounded-lg border border-border">
        ...
        <div className="block sm:hidden p-4 space-y-4">
          {clientes.map((cliente) => (
            <div key={cliente.id} className="rounded-lg border border-border p-4 flex flex-col gap-2 bg-white shadow-sm">
              <div className="font-semibold text-lg text-foreground">{cliente.nome}</div>
